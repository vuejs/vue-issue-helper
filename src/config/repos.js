const repos = [
  ...
  { id: 'vuejs/vue-router-next', name: 'vue-router-next', reproSubtitleId: 'router-next-repro-subtitle' },
  { id: 'vuejs/vue-loader', name: 'vue-loader' },
  { id: 'vuejs/vue-test-utils', name: 'vue-test-utils' },
  { id: 'vuejs/vue-cli', name: 'vue-cli', reproSubtitleId: 'cli-repro-subtitle' },
